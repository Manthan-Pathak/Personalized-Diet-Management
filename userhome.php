            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 logo-block">
                        <figure><a href="userhome.html"><img class="img-responsive" src="images/sitelogo.png" alt="Madang Logo" /></a></figure>
                    </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse">
                                    <ul class="nav navbar-nav text-right pull-right">
                                        ...
                                        <li><a href="c_cal.php">Maintainance Calorie</a></li>
                                         <li><a href="choose-plan-about-us.php">Create a Diet</a></li>
                    ...
                    <div class="dropdown">
                      <button class="dropbtn"> <?php echo $_SESSION['usrname']; ?> </button>
                      <div class="dropdown-content">
                        <a href="details.php">Your Details</a>
                        <a href="yourdiet.php">Your Diet</a>
                        <a href="logout.php">Logout</a>
                      </div>
                    </div>

                   <!-- <div class="col-xs-12 col-sm-2 nav-right-btn">
                        <a class="btn border-btn-small" href="logout.php">Logout</a>
                    </div> -->
                    ...
                    <div class="item">
                        ...
                        <div class="container">
                            <div class="banner-text text-center">
                                ...
                                <a href="choose-plan-about-us.html" class="btn">Select Program</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 choose wow fadeInLeft">
                            <div class="feature-item-wrap text-center">
                                ...
                                <h5><a class="text-lt" href="#">Enter Your Details</a></h5>
                        ...
                        <div class="col-xs-12 col-sm-4 deliver wow fadeInUp">
                            <div class="feature-item-wrap text-center">
                                ...
                                <h5><a class="text-lt" href="#">Know your Current bmi, calory intake etc.</a></h5>
                        ...
                        <div class="col-xs-12 col-sm-4 eat wow fadeInRight">
                            <div class="feature-item-wrap text-center">
                                ...
                                <h5><a class="text-lt" href="#">Get the diet</a></h5>
                ...
                <div class='container'>
                    <div class='row'>
                        ...
                        <div class="col-xs-12 col-sm-6 wow fadeInRight pull-right right-form-block">
                            ...
                            <form action="choose-plan-about-us.html">
                                <fieldset>
