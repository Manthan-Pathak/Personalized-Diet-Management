...
<body>
	...
	<div class="login-page">
	  <div class="form">
	    ...
	    <form class="login-form" action="updtdetails.php" method="post">
	     ...
	     <input style="text-align: center; "type="text" name="Name" value="<?php echo $res['usrname'];  ?>" />
	   <label>Your Email :</label>
	      <input style="text-align: center;"type="text" name="email" value="<?php  echo $res['email'];  ?>" />
<label>Your Mobile No :</label>
	      <input style="text-align: center; "type="text" name="mobno" value="<?php  echo $res['mobno'];  ?>" />
<label>Your Gender :</label>
	      <input style="text-align: center; "type="text" name="gen" value="<?php  echo $res['gen'];  ?>" />
...
<label>Are You Diabetic? :</label>
	      <input style="text-align: center; "type="text" name="diabetic?" value="<?php  echo $res['isdiabetic'];  ?>" />
<label>Your Food type :</label>
	      <input style="text-align: center; "type="text" name="type" value="<?php echo $res['foodtype'];    ?>" />

	      <button type="submit" name="submit" id="myBtn" >Update</button>
	      <br>
	  </br>
