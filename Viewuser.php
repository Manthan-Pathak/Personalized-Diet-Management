                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All User In The System</h4>
                                     <span align="right">
         ...
         <div class="modal" id="report" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="user_report.php" method="post" target="_blank">
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control">
                            ...
                            <option value="2">Gender based</option>
                            <option value="3">Food type based</option>
                            <option value="4">Activity Based</option>
                            <option value="5">Diabetic Based</option>
                        </select>
                    </div>
            ...
            $("#type").on('change', function() {
                ...
                if (type == 2) {
                    let html ='<div class="form-group">' +
                        '<input type="radio" name="gen" value="men" id="men" checked > <label for="Men">Men</label>' +
                        '<input type="radio" name="gen" value="women" id="women" style="margin-left: 20px;"> <label for="Women">Women</label>' +
                        // '<input type="radio" name="gen" value="snack" id="snacks" style="margin-left: 20px;"> <label for="snacks">snacks</label>' +
                        // '<input type="radio" name="gen" value="dinner" id="dinner" style="margin-left: 20px;"> <label for="dinner">dinner</label>' +
                        '</div>';
                    ...
                    let html ='<div class="form-group">' +
                        '<input type="radio" name="activity" value="sedentary" id="sedentary" checked > <label for="Sedentary ">Sedentary </label>' +
                        '<input type="radio" name="activity" value="light" id="light" style="margin-left: 20px;"> <label for="light ">light </label>' +
                        '<input type="radio" name="activity" value="moderate" id="moderate" style="margin-left: 20px;"> <label for="Moderate">Moderate</label>' +
                        '<input type="radio" name="activity" value="very" id="very" style="margin-left: 20px;"> <label for="Very ">Very </label>' +
                        '<input type="radio" name="activity" value="extra" id="extra" style="margin-left: 20px;"> <label for="Extra ">Extra </label>' +
                        '</div>';
                    $("#report_section").html(html);
                    }else if (type == 5) {
                     let html ='<div class="form-group">' +
                        '<input type="radio" name="diabetic" value="1" id="Yes" checked > <label for="Yes">Yes</label>' +
                        '<input type="radio" name="diabetic" value="0" id="No" style="margin-left: 20px;"> <label for="No">No</label>' +
                        '</div>';
                    $("#report_section").html(html);
                } else{
                    $("#report_section").html("");
