                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All Diets Assigned to Active Users</h4>
                                         <span align="right">
        ...
        <div class="right-bar">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="usrdiet_report.php" method="post" target="_blank">
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control">
                            ...
                            <option value="2">Based On Goals</option>
                            <option value="3">Based On User Id</option>
            ...
            $("#type").on('change', function() {
                ...
                if (type == 2) {
                    let html ='<div class="form-group">' +
                        '<input type="radio" name="goal" value="loose" id="loose" checked > <label for="loose">loose</label>' +
                        '<input type="radio" name="goal" value="maintain" id="maintain" style="margin-left: 20px;"> <label for="maintain">maintain</label>' +
                        '<input type="radio" name="gen" value="gain" id="gains" style="margin-left: 20px;"> <label for="gains">gains</label>' +
                    ...
                    let html ='<div class="form-group">' +
                        '<input type="number" name="usrid" id="usrid" placeholder="Enter User Id" >' +
                        '</div>';
                    $("#report_section").html(html);
                } else{
                    $("#report_section").html("");
