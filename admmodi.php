                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Modify Admin</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">People</a></li>
                                            <li class="breadcrumb-item active">Modify Admin</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-5">Modify Admin</h4>
                                        ...
                                        $sqlsel = "select * from admin where aid = '$id'";
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $sqlupdt = "UPDATE admin set name = '$name', email = '$email', pass = '$pass', mobno = '$mobno', isactive = '$isactive' where aid = $id ";
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-1 col-form-label">First name</label>
                                                <div class="col-sm-5">
                                                  <input type="text" class="form-control" name="name" value="<?php echo $res['name'];?>" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-email-input" class="col-sm-1 col-form-label">Email</label>
                                                <div class="col-sm-5">
                                                    <input type="email" class="form-control" name="email" value="<?php echo $res['email'];?>" id="horizontal-email-input">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-password-input" class="col-sm-1 col-form-label">Password</label>
                                                <div class="col-sm-5">
                                                  <input type="text" class="form-control" name="pass" value="<?php echo $res['pass'];?>" id="horizontal-password-input">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-password-input" class="col-sm-1 col-form-label">Mobile No.</label>
                                                <div class="col-sm-5">
                                                  <input type="text" class="form-control" name="mobno" value="<?php echo $res['mobno'];?>" id="horizontal-password-input">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-password-input" class="col-sm-2 col-form-label">Deactivate Account?</label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group row justify-content-end">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div>
                                                        <button type="submit" name="submit" class="btn btn-primary w-md">Modify</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
