...
<!-- Left Sidebar End -->
            ...
            if(isset($_POST['submit']))
            {
                ...
                $queryins = "INSERT into admin (name, email, pass, mobno, isactive, madmin) values ('$name', '$email', '$pass', '$mobno', 1, 0)";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Add Admin</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-5">Add Admin</h4>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-5">
                                                  <input type="password" name="pass" class="form-control" id="horizontal-password-input">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-password-input" class="col-sm-1 col-form-label">Mobile No.</label>
                                                <div class="col-sm-5">
                                                  <input type="text" name="mobno" class="form-control" id="horizontal-password-input">
                                                </div>
                                            </div>
