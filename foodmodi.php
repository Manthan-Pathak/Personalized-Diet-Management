...
<!-- Left Sidebar End -->
            ...
            <!-- ============================================================== -->
                ...
                <?php
                    ...
                    include 'dbcon.php';
                            $id = $_GET['id'];
                            $sqlsel = "select * from foodrec where fid = '$id'";
                        ...
                        if(isset($_POST['submit']))
                        {
                            ...
                            $sqlupdt = "UPDATE foodrec set foodname = '$foodname', step1 = '$step1', step2 = '$step2', step3 = '$step3', step4 = '$step4', cals = '$cals', prot = '$prot', fat = '$fat', carb = '$carb', foodtype='$type', isvegan = '$isvegan', fordiabetic = '$fordiabetic', foodcat = '$cat'  where fid = $id ";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-5">
                                                  <input type="text" name="foodname"  class="form-control" value="<?php echo $res['foodname']; ?>" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-email-input" class="col-sm-1 col-form-label">Step1</label>
                                                <div class="col-sm-5">
                                                    <textarea name="step1" class="form-control" placeholder="<?php echo $res['step1']; ?>" id="horizontal-email-input"></textarea>
                                                </div>
                                            </div>
                                           <div class="form-group row mb-4">
                                                <label for="horizontal-email-input" class="col-sm-1 col-form-label">Step2</label>
                                                <div class="col-sm-5">
                                                    <textarea name="step2" class="form-control" placeholder="<?php echo $res['step2']; ?>" id="horizontal-email-input"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-email-input" class="col-sm-1 col-form-label">Step3</label>
                                                <div class="col-sm-5">
                                                    <textarea name="step3" class="form-control" placeholder="<?php echo $res['step3']; ?>" id="horizontal-email-input"></textarea>
                                                </div>
                                            </div>
                                             <div class="form-group row mb-4">
                                                <label for="horizontal-email-input" class="col-sm-1 col-form-label">Step4</label>
                                                <div class="col-sm-5">
                                                    <textarea name="step4" class="form-control" placeholder="<?php echo $res['step4']; ?>" id="horizontal-email-input"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-1 col-form-label">Calories</label>
                                                <div class="col-sm-5">
                                                  <input type="text" name="cals" class="form-control" value="<?php echo $res['cals']; ?>" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                             <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-1 col-form-label">Protine</label>
                                                <div class="col-sm-5">
                                                  <input type="text" name="prot" class="form-control" value="<?php echo $res['prot']; ?>" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                             <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-1 col-form-label">Fats</label>
                                                <div class="col-sm-5">
                                                  <input type="text" name="fat" class="form-control" value="<?php echo $res['fat']; ?>" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                             <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-1 col-form-label">Carbs</label>
                                                <div class="col-sm-5">
                                                  <input type="text" name="carb" class="form-control" value="<?php echo $res['carb']; ?>" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                             <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-1 col-form-label">Type</label>
                                                <div class="col-sm-5">
                                                  <select name="type" value="<?php echo $res['foodtype']; ?>" class="form-control">
                                             ...
                                             <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-1 col-form-label" value="<?php echo $res['isvegan']; ?>">Is Vegan?</label>
                                            ...
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" value="<?php echo $res['fordiabetic']; ?>" class="col-sm-1 col-form-label">Diabetic?</label>
                                                <div class="col-sm-5">
                                            ...
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-firstname-input" value="foodcat" class="col-sm-1 col-form-label">Catagory</label>
                                                <div class="col-sm-5">
