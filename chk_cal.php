        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 text-center logo-block">
                    <figure><a href="userhome.php"><img class="img-responsive" src="images/madang-logo.png" alt="Madang Logo" /></a></figure>
                </div>
                <!-- ============== logo block ends ============== -->
            </div>
        </div>
...
<style>
.blue_button{background: none repeat scroll 0 0 #60ba62;border-bottom: 3px solid #3277BC;text-shadow: 1px 1px 0 #214D73;border: medium none;border-radius: 0.3em;color: #FFFFFF;cursor: pointer;font-weight: bold;margin: 10px 0;padding: 7px 14px;}
.frms input[type="text"], [type="password"], [type="file"], textarea, select {background: none repeat scroll 0 0 #fff;border: 1px solid #ddd;border-radius: 0.35em;height: 35px;margin-bottom: 15px;margin-top: 5px;padding: 0 0.5%;width: 99%;
}
...
<div align="center">
<p>Checked the Calories? Now Let us create a suitable plan for you <a href="choose-plan-about-us.html">Click Here to genrate meal plan</a></p>
...
$.ajax({
                    ...
                    method: 'POST',
                    data: {
                        cals:rc, fat:rf, prot:rp, carb:rh 
                    },
