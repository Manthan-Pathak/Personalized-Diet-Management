...
<!-- Mirrored from madang_h1.kenzap.com/home-version1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Oct 2020 10:37:04 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 logo-block">
                        <figure><a href="guesthome.html"><img class="img-responsive" src="images/sitelogo.png" alt="Madang Logo" /></a></figure>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-2 nav-right-btn">
                        <a class="btn border-btn-small" href="login.php">Login</a>
                    </div>
        ...
        <main>
           ...
           if(isset($_POST['submit']))
           {
                ...
                $emailquery = "Select * from usr where email = '$email' ";
                ...
                else
                {
                    if($pass === $cpass)
                    {
                        $sqlins = "INSERT INTO usr (usrname, email, pass, mobno, isactive) VALUES ('$name', '$email', '$passhash', '$mobno', 1)";
           ...
           ?>
            ...
            <section class='block select-program-block'>
                <div class='container'>
                    <div class='row' >
                        <div class="col-xs-12 col-sm-6 wow fadeInLeft left-image-block" style="height=100%">
                            <figure><img class="img-responsive" src="images/select-program-image.png" alt="Select program image" height="100%" /></figure>
                        </div>
                        <div class="col-xs-12 col-sm-6 wow fadeInRight pull-right right-form-block">
                            <h3 class='text-uppercase text-sp'>Register To Improove<br />YOUR LIFESTYLE</h3>
                            <form action="" method="POST">
                                <fieldset>
                                    ...
                                    <div class="text-uppercase text-lt text-sp">Your Name</div> 
                                     <input type="text" name="name" required/>
                                </fieldset>
                                <fieldset>
                                    <div class="text-uppercase text-lt text-sp">Your E-mail</div>
                                    <input type="text" name="email" required />
                                </fieldset>
                                <fieldset>
                                    <div class="text-uppercase text-lt text-sp">Your Contact Number</div>
                                    <input type="text" name="mobno" required/>
                                </fieldset>
                                <fieldset>
                                    <div class="text-uppercase text-lt text-sp">Select A Password</div>
                                    <input type="Password" name="pass" required/>
                                </fieldset>
                                <fieldset>
                                    <div class="text-uppercase text-lt text-sp">Retype Password</div>
                                    <input type="Password" name="cpass" required/>
                                </fieldset>
                                <fieldset>
                                    <input type="submit" class='btn hvr-wobble-horizontal text-lt text-sp' value='Register' name="submit" />
                                </fieldset>
                                <fieldset>
...
<!-- Mirrored from madang_h1.kenzap.com/home-version1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Oct 2020 10:41:00 GMT -->
</html>