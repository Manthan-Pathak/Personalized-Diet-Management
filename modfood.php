                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                             <?php
                                                ...
                                                <td><a href="foodmodi.php?id=<?php echo $res['fid']; ?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                                <td><a href="fooddel.php?id=<?php echo $res['fid']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                                </tr>
