        ...
        <div class="modal" id="report" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="adm_report.php" method="post" target="_blank">
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control">
                            ...
                            <option value="2">Admin Id based</option>
                            <option value="3">Admin's Status based</option>
            ...
            $("#type").on('change', function() {
                ...
                if (type == 3) {
                    let html ='<div class="form-group">' +
                        '<input type="radio" name="isactive" value="1" id="1" checked > <label for="Active">Active</label>' +
                        '<input type="radio" name="isactive" value="0" id="0" style="margin-left: 20px;"> <label for="Inactive">Inactive</label>' +
                    ...
                    let html ='<div class="form-group">' +
                        '<input type="number" name="aid" id="aid" placeholder="Enter Admin\'s Id" >' +
                        '</div>';
                    $("#report_section").html(html);
                } else{
                    $("#report_section").html("");
